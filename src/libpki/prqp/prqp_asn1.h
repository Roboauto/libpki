...
DECLARE_ASN1_DUP_FUNCTION(CERT_IDENTIFIER);
...
DECLARE_ASN1_DUP_FUNCTION(PKI_PRQP_REQ);
...
DECLARE_ASN1_DUP_FUNCTION(RESOURCE_RESPONSE_TOKEN);
...
DECLARE_ASN1_DUP_FUNCTION(PKI_PRQP_RESP);
